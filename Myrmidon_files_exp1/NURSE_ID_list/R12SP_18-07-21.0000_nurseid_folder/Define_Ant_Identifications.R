#Open Experiment
tracking_data <- fmExperimentOpen("R12SP_18-07-21.0000.myrmidon") #if it says it's locked, click Session>Restart R and clear objects from workspace including hidden ones
##GENERAL INFO
...
tracking_data$save("/media/adriano/DISK3/ADRIANO/NURSEID/R12SP_18-07-21.0000_nurseid_folder/R12SP_18-07-21.0000.myrmidon")
