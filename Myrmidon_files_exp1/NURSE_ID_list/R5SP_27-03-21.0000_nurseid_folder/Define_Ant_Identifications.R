#Open Experiment
tracking_data <- fmExperimentOpen("R5SP_27-03-21.0000_nurseid.myrmidon") #if it says it's locked, click Session>Restart R and clear objects from workspace including hidden ones
##GENERAL INFO
...
tracking_data$save("/media/adriano/DISK3/ADRIANO/NURSEID/R5SP_27-03-21.0000_nurseid_folder/R5SP_27-03-21.0000_nurseid.myrmidon")
