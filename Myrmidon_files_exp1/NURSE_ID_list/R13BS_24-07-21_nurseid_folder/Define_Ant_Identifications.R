#Open Experiment
tracking_data <- fmExperimentOpen("R13BS_24-07-21_nurseid.myrmidon") #if it says it's locked, click Session>Restart R and clear objects from workspace including hidden ones
##GENERAL INFO
...
tracking_data$save("/media/adriano/DISK4/ADRIANO/NURSEID/R13BS_24-07-21_nurseid_folder/R13BS_24-07-21_nurseid.myrmidon")
