...
define_ants <- T ###change back to TRUE when you do a new colony
...
setwd("/media/adriano/DISK3/ADRIANO/NURSEID/R6SP_03-04-21.0000_nurseid_folder/R6SP_03-04-21.0000_nurseid.myrmidon")
myrmidon_file <- "R6SP_03-04-21.0000_nurseid.myrmidon"
##########DEFINE ANTS#############
