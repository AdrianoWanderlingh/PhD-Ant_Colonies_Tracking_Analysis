#Open Experiment
tracking_data <- fmExperimentOpen("R7BS_09-04-21.0000_nurseid.myrmidon") #if it says it's locked, click Session>Restart R and clear objects from workspace including hidden ones
##GENERAL INFO
...
tracking_data$save("/media/adriano/DISK3/ADRIANO/NURSEID/R7BS_09-04-21.0000_nurseid_folder/R7BS_09-04-21.0000_nurseid.myrmidon")
