#Open Experiment
tracking_data <- fmExperimentOpen("R8BS_16-04-21.0000_nurseid.myrmidon") #if it says it's locked, click Session>Restart R and clear objects from workspace including hidden ones
##GENERAL INFO
...
tracking_data$save("/media/adriano/DISK4/ADRIANO/NURSEID/R8BS_16-04-21.0000_nurseid_folder/R8BS_16-04-21.0000_nurseid.myrmidon")
