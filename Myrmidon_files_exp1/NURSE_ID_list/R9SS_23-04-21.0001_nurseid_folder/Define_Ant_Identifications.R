#Open Experiment
tracking_data <- fmExperimentOpen("R9SS_23-04-21.0001_nurseid.myrmidon") #if it says it's locked, click Session>Restart R and clear objects from workspace including hidden ones
##GENERAL INFO
...
tracking_data$save("/media/adriano/DISK4/ADRIANO/NURSEID/R9SS_23-04-21.0001_nurseid_folder/R9SS_23-04-21.0001_nurseid.myrmidon")
