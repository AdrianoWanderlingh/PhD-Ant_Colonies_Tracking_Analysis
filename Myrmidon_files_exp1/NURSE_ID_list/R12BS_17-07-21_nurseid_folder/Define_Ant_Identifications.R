#Open Experiment
tracking_data <- fmExperimentOpen("R12BS_17-07-21_nurseid.myrmidon") #if it says it's locked, click Session>Restart R and clear objects from workspace including hidden ones
##GENERAL INFO
...
tracking_data$save("/media/adriano/DISK3/ADRIANO/NURSEID/R12BS_17-07-21_nurseid_folder/R12BS_17-07-21_nurseid.myrmidon")
