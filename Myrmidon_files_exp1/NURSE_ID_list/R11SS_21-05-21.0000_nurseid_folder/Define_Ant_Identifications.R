#Open Experiment
tracking_data <- fmExperimentOpen("R11SS_21-05-21.0000_nurseid.myrmidon") #if it says it's locked, click Session>Restart R and clear objects from workspace including hidden ones
##GENERAL INFO
...
tracking_data$save("/media/cf19810/DISK3/ADRIANO/NURSEID/R11SS_21-05-21.0000_nurseid_folder/R11SS_21-05-21.0000_nurseid.myrmidon")
