...
no_capsule_list <- list(
  paste(dir_data,"REP2/R2SP_06-03-21.0000_Oriented.myrmidon",sep=''), #leamas
  paste(dir_data,"REP3/R3SP_13-03-21_Oriented.myrmidon",sep=''), #prideaux
  paste(dir_data,"REP7/R7SP_10-04-21_Oriented.myrmidon",sep=''), #karla
  paste(dir_data,"REP8/R8SP_17-04-21_Oriented.myrmidon",sep='')) #westerby
