...
print(ToOrient_myr_file)
    ...
    # if ( !file.exists(paste0(sub("\\..*", "", ToOrient_myr_file),"_AutoOriented_withMetaData_NS.myrmidon"))) {
      ...
      #  PUT THE VARIOUS       fmQueryGetDataInformations(ToOrient_data)$details IN A DATAFRAME, IF YOU CAN'T FIND THE WAY OF PRINTING START AND STOP FRAME IS OK.
      # THEN PRINT RELEVANT INFO FOR COMPARISON
