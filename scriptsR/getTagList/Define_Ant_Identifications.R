#Open Experiment
tracking_data <- fmExperimentOpen("cold_sampling_big_test.myrmidon") #if it says it's locked, click Session>Restart R and clear objects from workspace including hidden ones
##GENERAL INFO
...
tracking_data$save("/media/adriano/Elements/ADRIANO_EXPERIMENT/cold_sampling_big_test_folder/cold_sampling_big_test.myrmidon")
