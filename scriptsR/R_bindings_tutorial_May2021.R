...
tracking_data$save("/home/cf19810/Documents/Postprocessing_training/training_blank.myrmidon")  
...
objectss <- fmQueryComputeMeasurementFor(e,1,1)
...
ant_list$antID_str <-  paste("ant",ant_list$antID,sep="")
...
e$save("/home/cf19810/Documents/Postprocessing_training/training.myrmidon")
rm(list=c("e"))
gc()
